...
left_column = [
    ...
    [
        sg.Button(
            button_text="Correct All", enable_events=True, pad=(10, 20), button_color="#cc4827", key="__CORRECT__"
        ),
...
viewer = [[sg.Frame("", layout=info, key="__INFO__"), sg.Image(visible=False, key="__PREVIEW__")]]
